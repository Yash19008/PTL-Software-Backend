...
class AddOtherColumn extends Migration
{
    ...
    public function up()
    {
        ...
        DB::statement("CREATE OR REPLACE VIEW order_master_view AS
                        ...
                        , om.challan_bulk_action_date, om.challan_id, om.pkt_grs_weight, om.sheet, om.pkg_mode, om.pkt_grs, om.loc, om.bdls, om.size_cms_length, om.size_cms_width, om.company,
