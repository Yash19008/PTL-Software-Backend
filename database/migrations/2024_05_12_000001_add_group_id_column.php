...
class AddGroupIdColumn extends Migration
{
    ...
    public function up()
    {
        ...
        DB::statement("CREATE OR REPLACE VIEW order_master_view AS
                        select om.id, om.group_id, om.date, om.cust_id, cm.company_name, om.quality, om.size_inch_length, om.size_inch_width , om.gsm, om.qty, om.weight, om.delivery_at, om.challan_number,om.gwd, om.last_searched_id
